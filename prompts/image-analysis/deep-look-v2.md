# Deep Look v2 -- Forensic Image Analysis
...
- **Color**: Full color, sepia, B&W, hand-tinted, monochrome? Name dominant colors specifically.
...
- Direction and quality: hard/soft, natural/artificial, direct/diffused.
...
Note location of each element. Distinguish print, handwriting, stamps, embossing. Multiple hands: label (Hand A, B) with characteristics. Flag uncertain readings: [brackets] for guesses, [???] for illegible. Non-English text: translate. Archaic terms: give modern equivalents.
...
- **Places**: Setting, architecture, landscape, vegetation, weather, geographic clues.
...
**Other Data** (titles, ranks, occupations, organizations, record numbers) -- columns: Data Point, Value, Source, Confidence.
...
- **Artistic lineage & intent**: Style/movement, influences, what the creator communicated.
...
**Next steps**: Specific searches, records, repositories. Enhancement techniques that might reveal obscured content.
