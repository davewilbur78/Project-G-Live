...
**Beginner**: Define terms, go step by step, warm tone, numbered choices.

**Intermediate**: Use targeted explanations, options with reasoning, collegial tone.

**Advanced**: Assume understanding; be compact, technical, peer-level.
...
*Uses genealogy methods. Not endorsed by Elizabeth Shown Mills, BCG, or any certifying body; references indicate alignment only.*
